...
| Page | What you'll do |
|---|---|
| [Variables & Expressions](expressions.md) | Create variables and build expressions with arithmetic and math functions |
...
signatures see [Reference](../reference/index.md).
