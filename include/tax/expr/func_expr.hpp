...
class FuncExpr : public tax::Expr< FuncExpr< E, Op >, typename E::scalar_type, E::order_ct, E::size_ct >
{
   public:
...
class ParamFuncExpr
    : public tax::Expr< ParamFuncExpr< E, Op, P >, typename E::scalar_type, E::order_ct, E::size_ct >
{
   public:
    using T = typename E::scalar_type;
    static constexpr int N = E::order_ct, M = E::size_ct;
...
class BinFuncExpr
    : public tax::Expr< BinFuncExpr< L, R, Op >, typename L::scalar_type, L::order_ct, L::size_ct >
{
    static_assert( L::order_ct == R::order_ct && L::size_ct == R::size_ct &&
...
class TerFuncExpr
    : public tax::Expr< TerFuncExpr< A, B, C, Op >, typename A::scalar_type, A::order_ct, A::size_ct >
{
    static_assert( A::order_ct == B::order_ct && B::order_ct == C::order_ct && A::size_ct == B::size_ct &&
                   B::size_ct == C::size_ct &&
