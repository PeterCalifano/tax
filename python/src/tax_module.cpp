...
#undef TAX_BIND_UNARY
    ...
    // -----------------------------------------------------------------------
    // tax.la submodule — linear-algebra niceties: re-exports of Vec / Mat
    // and the free `norm` / `dot` / `cross` functions. The methods on the
    // Vec / Mat classes themselves are the same operations.
    // -----------------------------------------------------------------------
    nb::module_ la_mod = m.def_submodule( "la",
        "Linear-algebra helpers for TaylorExpansion vectors / matrices." );
