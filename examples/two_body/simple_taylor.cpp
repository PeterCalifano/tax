...
// dense output sampled at discrete times. Writes:
//   simple_taylor_traj.csv     — t, x, y, vx, vy at snapshot times
...
int main()
{
    ...
    std::cout << "[simple_taylor] elapsed: " << elapsed_ms << " ms, "
              << n_steps << " accepted steps\n";

    std::ofstream traj( "simple_taylor_traj.csv" );
    traj << "t,x,y,vx,vy\n";
    ...
    std::ofstream timing( "simple_taylor_timing.txt" );
    timing << "method=simple_taylor\n"
